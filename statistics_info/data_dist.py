...
def calculate_scan_range_boundary_ratio(profile_path, output_file_path, output_dir_path="."):
	import sys
	global data_dist	
	...
	with open(output_file_path, 'w', newline='') as csv_file:
		...
		for nid in per_scan_node_stats.keys():
			server_idx =  per_node_server_idx[nid]
			plan_node_idx = nid
			...
			records.append([plan_node_idx, upper_boundary_scan_range_ratio, lower_boundary_scan_range_ratio])
			...
			records.append([server_idx, plan_node_idx, upper_boundary_disk_splits_ratio, lower_boundary_disk_splits_ratio])
		csv_writer.writerows(records)
...
if __name__ == '__main__':
	...
	handle_profiles(calculate_scan_range_boundary_ratio, os.path.normpath(profile), os.path.normpath(output), 'distest')
